      ...
      <div className="flex-1 p-6">
        <Card>
          <CardContent className="py-16 text-center">
            ...
            <Link href="/documents/bons-commande/nouveau" className="inline-flex items-center gap-2 bg-[#3b82f6] text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-[#2563eb]">
              + Créer
            </Link>
          </CardContent>
        </Card>
